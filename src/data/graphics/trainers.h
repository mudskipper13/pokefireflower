...
const struct TrainerBacksprite gTrainerBacksprites[] =
{
    ...
    TRAINER_BACK_SPRITE(RS_BRENDAN, 4, RubySapphireBrendan, Palette_RubySapphireBrendan, Hoenn),
    TRAINER_BACK_SPRITE(RS_MAY, 4, RubySapphireMay, Palette_RubySapphireMay, Hoenn),
