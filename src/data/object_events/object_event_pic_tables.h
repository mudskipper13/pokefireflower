...
static const struct SpriteFrameImage sPicTable_BrendanSurfing[] = {
    ...
    overworld_frame(gObjectEventPic_BrendanSurfing, 4, 4, 6),
    ...
    overworld_frame(gObjectEventPic_BrendanSurfing, 4, 4, 7),
};
...
static const struct SpriteFrameImage sPicTable_Twin[] = {
    overworld_ascending_frames(gObjectEventPic_Twin, 2, 2),
};
...
static const struct SpriteFrameImage sPicTable_MaySurfing[] = {
    ...
    overworld_frame(gObjectEventPic_MaySurfing, 4, 4, 6),
    ...
    overworld_frame(gObjectEventPic_MaySurfing, 4, 4, 7),
};
...
static const struct SpriteFrameImage sPicTable_LugiaOld[] = {
    obj_frame_tiles(gObjectEventPic_LugiaOld),
};

static const struct SpriteFrameImage sPicTable_HoOhOld[] = {
    overworld_ascending_frames(gObjectEventPic_HoOhOld, 4, 4),
};
...
static const struct SpriteFrameImage sPicTable_ProfMarcus[] = {
    overworld_ascending_frames(gObjectEventPic_ProfMarcus, 2, 4),
};

static const struct SpriteFrameImage sPicTable_Twin2[] = {
    overworld_ascending_frames(gObjectEventPic_Twin2, 2, 2),
};
