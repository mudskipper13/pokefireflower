...
u8 MovementAction_FollowerEmote_Step0(struct ObjectEvent *, struct Sprite *);
...
u8 MovementAction_EmoteDots_Step0(struct ObjectEvent *, struct Sprite *);
...
u8 (*const gMovementActionFuncs_EmoteDots[])(struct ObjectEvent *, struct Sprite *);
...
u8 (*const *const gMovementActionFuncs[])(struct ObjectEvent *, struct Sprite *) = {
    ...
    [MOVEMENT_ACTION_EMOTE_DOTS] = gMovementActionFuncs_EmoteDots,
...
u8 (*const gMovementActionFuncs_AcroUnusedAcroActionDown[])(struct ObjectEvent *, struct Sprite *) = {
    MovementAction_FollowerEmote_Step0,
    MovementAction_WaitSpriteAnim,
    MovementAction_PauseSpriteAnim,
};
...
u8 (*const gMovementActionFuncs_EmoteDots[])(struct ObjectEvent *, struct Sprite *) = {
    MovementAction_EmoteDots_Step0,
    MovementAction_Finish,
};
