...
void CB2_InitOptionMenu(void)
{
    ...
    case 10:
    {
        ...
        gTasks[taskId].tClockMode = gSaveBlock2Ptr->optionsClockMode;
        ...
        ClockMode_DrawChoices(gTasks[taskId].tClockMode);
...
static void Task_OptionMenuSave(u8 taskId)
{
    ...
    gSaveBlock2Ptr->optionsClockMode = gTasks[taskId].tClockMode;
...
static void ClockMode_DrawChoices(u8 selection)
{
    ...
    DrawOptionMenuChoice(gText_ClockMode12Hours, 104, YPOS_CLOCKMODE, styles[0]);
    DrawOptionMenuChoice(gText_ClockMode24Hours, GetStringRightAlignXOffset(FONT_NORMAL, gText_ClockMode, 210), YPOS_CLOCKMODE, styles[1]);
}
