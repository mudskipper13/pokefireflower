...
static void CB2_SaveFailedScreen(void)
{
    ...
    default:
        ...
        DrawStdFrameWithCustomTileAndPalette(sWindowIds[TEXT_WIN_ID], FALSE, STD_WINDOW_BASE_TILE_NUM, 14);
        DrawStdFrameWithCustomTileAndPalette(sWindowIds[CLOCK_WIN_ID], FALSE, STD_WINDOW_BASE_TILE_NUM, 14);
