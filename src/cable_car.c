...
static void CreateCableCarSprites(void)
{
    ...
    switch (GOING_DOWN)
    {
        ...
        default:
            ...
            spriteId = CreateObjectGraphicsSpriteNoTint(playerGraphicsIds[gSaveBlock2Ptr->playerGender], SpriteCB_Player, 200, 73, 102);
        ...
        case TRUE:
            ...
            // Create player sprite
            spriteId = CreateObjectGraphicsSpriteNoTint(playerGraphicsIds[gSaveBlock2Ptr->playerGender], SpriteCB_Player, 128, 39, 102);
            if (spriteId != MAX_SPRITES)
            {
                gSprites[spriteId].oam.priority = 2;
                gSprites[spriteId].x2 = 8;
    ...
    if ((rval % 64) == 0)
    {
        ...
        spriteId = CreateObjectGraphicsSpriteNoTint(hikerGraphicsIds[rval % (ARRAY_COUNT(hikerGraphicsIds) - 1)], hikerCallbacks[GOING_DOWN], hikerCoords[GOING_DOWN][0], hikerCoords[GOING_DOWN][1], 106);
        if (spriteId != MAX_SPRITES)
        {
            gSprites[spriteId].oam.priority = 2;
